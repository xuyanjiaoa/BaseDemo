package com.emp.yjy.cameralib.camera2;
...
public class CameraKit2MultiPreview {
    private static final String TAG = "Camera2Helper";
    private Activity mActivity;
    //    private AutoFitTextureView mTextureView;
    private List<AutoFitTextureView> mAutoFitTextureViews = new ArrayList<>();
    ...
    public CameraKit2MultiPreview(@NonNull Activity activity, @NonNull AutoFitTextureView... textureView) {
        this.mActivity = activity;
        int length = textureView.length;
        for (int i = 0; i < length; i++) {
            mAutoFitTextureViews.add(textureView[i]);
        }
    }
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            for (AutoFitTextureView autoFitTextureView : mAutoFitTextureViews) {
...
//            Surface surface = new Surface(texture);
    ...
    public void open() {
        ...
        if (mAutoFitTextureViews != null && mAutoFitTextureViews.size() >= 1) {
            AutoFitTextureView autoFitTextureView = mAutoFitTextureViews.get(0);
     ...
     */
    public CameraKit2MultiPreview setImageFormat(int format) {
        mImageFormat = format;
        return this;
    }
     ...
     * 获取摄像头方向
     *
     * @return 方向，详见mSensorOrientation赋值 {@link CameraKit2MultiPreview#setUpCameraOutputs}
     */
     ...
     */
    public CameraKit2MultiPreview setOnOpenErrorListener(OnOpenErrorListener listener) {
     ...
     * @param listener 回调listener
     */
    public CameraKit2MultiPreview setOnImageAvailableListener(OnPreviewCallbackListener listener) {
