...
public class CameraKit2 {
    ...
    public CameraKit2(@NonNull Activity activity, @NonNull AutoFitTextureView textureView) {
     ...
     */
    public CameraKit2 setImageFormat(int format) {
        mImageFormat = format;
        return this;
    }
     ...
     * 获取摄像头方向
     *
     * @return 方向，详见mSensorOrientation赋值 {@link CameraKit2#setUpCameraOutputs}
     */
     ...
     */
    public CameraKit2 setOnOpenErrorListener(OnOpenErrorListener listener) {
     ...
     * @param listener 回调listener
     */
    public CameraKit2 setOnImageAvailableListener(OnPreviewCallbackListener listener) {
